...
//
// If you fixed your bugs, main should run successfully and all your tests should pass.
// Feel free to play around with the code! :D
//
int main() {    
    cout << "------------------------------" << endl;
	...
	if (processed_rich) {
		...
		cout << "Oh no! We don't have enough food for a customer, so they went away :(";
		cout << endl<< endl;
	}
